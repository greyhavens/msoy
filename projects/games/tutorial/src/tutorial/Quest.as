...
public class Quest
{
    ...
    protected static function fillQuests () :void
    {
        ...
        _quests.push(new Quest(
            ...
            "<br><li>Click <b><i>Buy!</i></b> when you find something you like.<br>" +
            "</p>",
        ...
        _quests.push(new Quest(
            ...
            "<p class='details'>" +
            "<br><li>You should be in Room Editing Mode. If not, click the small hammer icon on the lower Whirled toolbar.<br>" +
