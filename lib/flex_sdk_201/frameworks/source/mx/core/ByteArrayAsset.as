...
/**
 *  ByteArrayAsset is a subclass of the Flash Player's ByteArray class
 *  which represents an arbitrary sequence of byte data that you embed
 *  in a Flex application.
 *
 *  <p>The byte data that you're embedding can be in any kind of file,
 ...
 *  The MXML compiler autogenerates a class that extends ByteArrayAsset
 ...
 *  into the bitmap format used by the Flash Player, and a subclass
