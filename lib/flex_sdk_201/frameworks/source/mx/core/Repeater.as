...
public class Repeater extends UIComponent implements IRepeater
{
     ...
     *  @private
     */
    private static var resourceNotExecuting:String;
    ...
    {
        resourceNotExecuting = packageResources.getString("notExecuting");
    }
     ...
     * @inheritDoc
     */
    public function initializeRepeater(container:Container,
     ...
     *  or count changes.
     */
    private function removeAllChildren(container:Container):void
    {
                                    ...
                                    recurse:Boolean):IFlexDisplayObject
    {
        ...
        var child:IFlexDisplayObject = container.createComponentFromDescriptor(
                                                descriptor, recurse);
    ...
    private function getIndexForFirstChild():int
    {
        ...
        var i:int = 0;
        var cc:Array = container.createdComponents;
        var length:int = cc ? cc.length : 0;

        while (i < length)
        {
            var component:IFlexDisplayObject = container.createdComponents[i];
    ...
    private function recreate():void
    {
        ...
        removeAllChildRepeaters(container);
    ...
    private function removeRepeater(repeater:Repeater):void
    {
        ...
        repeater.removeAllChildRepeaters(repeater.container);

        removeChildRepeater(container, repeater);
