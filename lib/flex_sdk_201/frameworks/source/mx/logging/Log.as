 ...
 *  There are several different targets provided: <code>XMLLogTarget</code>,
 *  <code>MiniDebugTarget</code>, <code>DebugChannelTarget</code>,
 *  <code>TraceTarget</code>, etc.
...
public class Log
{
     ...
     *  @private
     */ 
    private static var resourceInvalidTarget:String;

    /**
     *  @private
     */ 
    private static var resourceInvalidLen:String;

    /**
     *  @private
     */ 
    private static var resourceInvalidChars:String;
    ...
    {
        resourceInvalidTarget = packageResources.getString("invalidTarget");

        resourceInvalidLen = packageResources.getString("invalidLen");

        resourceInvalidChars = packageResources.getString("invalidChars");
    }
    ...
    public static function addTarget(target:ILoggingTarget):void
    {
        if(target)
        {
            ...
            throw new ArgumentError(resourceInvalidTarget);
    }
    ...
    private static function checkCategory(category:String):void
    {
        if(category == null || category.length == 0)
            throw new InvalidCategoryError(resourceInvalidLen);

        if(hasIllegalCharacters(category) || (category.indexOf("*") != -1))
            throw new InvalidCategoryError(resourceInvalidChars);
    }
