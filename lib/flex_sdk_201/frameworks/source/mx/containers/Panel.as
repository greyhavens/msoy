...
public class Panel extends Container
{
    ...
    override public function get viewMetrics():EdgeMetrics
    {
        ...
        var vm:EdgeMetrics = panelViewMetrics;
    ...
    override protected function createChildren():void
    {
        ...
        if (!statusTextField)
        {
            statusTextField = new UITextField();
    ...
    /**
     *  @private. Returns a Rectangle containing the largest piece of header
