       ...
       implements ICollectionView, IList, IMXMLObject
{
    ...
    private static function loadResources():void
    {
        ...
        resourceIncorrectAddition =
            packageResources.getString("incorrectAddition");
    ...
    */
     ...
     *  The VM will call this method when code like <code>"foo" in Bar</code>
     *  
    ...
    // any methods that can't be found on this class shouldn't be called, so return null
    /**
     *  @private
     */
                                      ...
                                      dispatch:Boolean=true, updateEventItems:Array = null):void
    {
        if (localIndex)
        {
            ...
            var addLocation:int = addItemsToView([item], -1, false);
