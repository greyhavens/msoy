...
public class XMLNotifier
{
     ...
     */
    mx_internal static function initializeXMLForNotification(node:XML):Function
    {
     ...
     */
    public function watchXML(xml:Object, notifiable:IXMLNotifiable):void
    {
    	...
    	if (!(watcherFunction is Function))
    		watcherFunction = initializeXMLForNotification(xitem);
