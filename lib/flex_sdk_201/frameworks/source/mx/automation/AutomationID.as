 ...
 *  that QTP can use. AutomationID consists of many AutomationIDParts, where each part
 ...
 *  this AutomationID is passed to QTP  and QTP parses this information and updates its OR.</p>
 * <p>During playback when QTP provides AutomationID for finding an object, the Display object
 ...
 *  <p>QTP makes  AutomationIDs persistent by saving them in the OR. Other agents should
