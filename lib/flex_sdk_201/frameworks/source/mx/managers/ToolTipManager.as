...
public class ToolTipManager extends EventDispatcher
{
	 ...
	 *  @private
	 */
	private static var impl:IToolTipManager = Singleton
	    .getInstance("mx.managers::IToolTipManager") as IToolTipManager;
	 ...
	 *  @default null
	 */
	public static function get hideEffect():Effect
	{
		return impl.hideEffect;
	}
	public static function set hideEffect(value:Effect):void
	{
	 ...
	 *  @default null
	 */
	public static function get showEffect():Effect
	{
		return impl.showEffect;
	}
	public static function set showEffect(value:Effect):void
	{
	...
	{
	    impl.registerErrorString(target, errorString);
	}
