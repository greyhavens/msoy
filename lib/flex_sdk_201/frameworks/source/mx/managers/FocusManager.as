 ...
 *  of text. To the Flash Player, that UITextField has focus. However, from the 
...
public class FocusManager implements IFocusManager
{
	...
	public function activate():void
	{
		...
		form.systemManager.displayListHandle.addEventListener(FocusEvent.MOUSE_FOCUS_CHANGE, mouseFocusChangeHandler, false, 0, true);
		form.systemManager.displayListHandle.addEventListener(FocusEvent.KEY_FOCUS_CHANGE, keyFocusChangeHandler, false, 0, true);
		form.addEventListener(FocusEvent.FOCUS_IN, focusInHandler, true);
		form.addEventListener(FocusEvent.FOCUS_OUT, focusOutHandler, true);
		form.systemManager.displayListHandle.addEventListener(Event.ACTIVATE, activateHandler, false, 0, true);
		form.systemManager.displayListHandle.addEventListener(Event.DEACTIVATE, deactivateHandler, false, 0, true);
	...
	public function deactivate():void
	{
		...
		form.systemManager.displayListHandle.removeEventListener(FocusEvent.MOUSE_FOCUS_CHANGE, mouseFocusChangeHandler);
		form.systemManager.displayListHandle.removeEventListener(FocusEvent.KEY_FOCUS_CHANGE, keyFocusChangeHandler);
		form.removeEventListener(FocusEvent.FOCUS_IN, focusInHandler, true);
		form.removeEventListener(FocusEvent.FOCUS_OUT, focusOutHandler, true);
		form.systemManager.displayListHandle.removeEventListener(Event.ACTIVATE, activateHandler);
		form.systemManager.displayListHandle.removeEventListener(Event.DEACTIVATE, deactivateHandler);
	...
	private function keyDownHandler(event:KeyboardEvent):void
	{
		...
		var sm:SystemManager = SystemManager(form.systemManager);
		sm.idleCounter = 0;
