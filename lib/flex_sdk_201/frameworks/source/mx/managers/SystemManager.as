						   ...
						   IFlexModuleFactory, ISystemManager
{
	...
	mx_internal function initialize():void
	{
		...
		var rslURLList:Array = [];
		var rslSizes:Array = [];
		var rsls:Array = info()["rsls"];

		for (var i:int = 0; rsls && i < rsls.length; ++i)
		{
		    rslURLList[i] = rsls[i].url;
		    rslSizes[i] = rsls[i].size;
		}
	 ...
	 */
	static public function getSWFRoot(object:Object):DisplayObject
	{
