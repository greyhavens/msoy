 ...
 *  
 *  <p>The Tree class uses an ITreeDataDescriptor object to parse and
...
public class Tree extends List implements IIMESupport
{
     ...
     *  @private
     */
    private static var resourceUnknownInput:String;
    ...
    {
        resourceUnknownInput = packageResources.getString("unknownInput");
    }
    ...
    */
     ...
     */
    mx_internal var wrappedCollection:HierarchicalCollectionView;
    ...
    */
    ...
    override mx_internal function addClipMask(layoutChanged:Boolean):void
    {
        ...
        listContent.scrollRect = new Rectangle(
            ...
            unscaledHeight - vm.left - vm.right);
    }
     ...
     *  @param columnIndex The columnIndex associated with this item. 
     *  
    ...
    */
                              ...
                              cause:Event = null):void
    {
        ...
        if (animate && rowIndex < rC && rowsToMove > 0 && rowsToMove < 20 && dur!=0)
        {
            ...
            var xx:Number = getStyle("paddingLeft");
    ...
    private function getIndent():Number
    {
        ...
        for (var p:String in _openItems)
        {
            ...
            depth = Math.max(getItemDepth(_openItems[p], 0), depth);
        }
    ...
    */
     ...
     * 
     *  By default, only <code>DragManager.MOVE</code> drag actions are supported. 
     *  To support <code>DragManager.COPY</code> 
     *  drag actions, you must write a custom <code>dragDropHandler()</code> method that 
     *  implements the copy of the Tree data based on its structure.  
     *
    ...
    /**
     *  Handles <code>DragEvent.DRAG_COMPLETE</code> events.
     * 
     *  By default, only <code>DragManager.MOVE</code> drag actions are supported. 
     *  To support <code>DragManager.COPY</code> 
     *  drag actions, you must write a custom <code>dragDropHandler()</code> method that 
