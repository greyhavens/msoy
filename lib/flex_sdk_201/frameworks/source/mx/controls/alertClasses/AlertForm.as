...
public class AlertForm extends UIComponent
{
	...
	override protected function createChildren():void
	{
		...
		var defaultButtonFlag:uint = Alert(parent).defaultButtonFlag;

		var button:Button;

		if (buttonFlags & Alert.OK)
		{
			button = createButton(Alert.okLabel, "OK");
		...
		{
			button = createButton(Alert.yesLabel, "YES");
		...
		{
			button = createButton(Alert.noLabel, "NO");
		...
		{
			button = createButton(Alert.cancelLabel, "CANCEL");
