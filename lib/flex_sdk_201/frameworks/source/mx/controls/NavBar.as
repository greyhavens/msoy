...
public class NavBar extends Box
{
     ...
     *  @private
     */
    private static var resourceErrWrongType:String;

    /**
     *  @private
     */
    private static var resourceErrWrongContainer:String;
    ...
    {
        resourceErrWrongType = packageResources.getString("errWrongType");

        resourceErrWrongContainer = packageResources.getString("errWrongContainer");
    }
    ...
    public function set dataProvider(value:Object /* can be either String, ViewStack, Array or IList */):void
    {
        if (value &&
            ...
            !(value is IList))
        {
            throw new Error(StringUtil.substitute(resourceErrWrongContainer, id));
        }
    ...
    private function createNavChildren():void
    {
        ...
        for (var i:int = 0; i < n; i++)
        {
            ...
            {
                var label:String = item[labelField];
                        ...
                        newStack:Object /* can be String or ViewStack */):void
    {
        ...
        for (var i:int = 0; i < numViews; i++)
        {
            ...
            var item:Button = Button(createNavItem(child.label, child.icon));
    ...
    private function childAddHandler(event:ChildExistenceChangedEvent):void
    {
        ...
        var item:Button = Button(createNavItem(newChild.label, newChild.icon));
