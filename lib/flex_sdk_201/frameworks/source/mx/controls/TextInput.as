...

{
     ...
     *  @private
     */
    private static var resourceUnsupportedMode:String;
    ...
    {
        resourceUnsupportedMode = packageResources.getString("unsupportedMode");
    }
    ...
    override public function get baselinePosition():Number
    {
        ...
        return (border && border is RectangularBorder ?
                RectangularBorder(border).borderMetrics.top :
   ...
   /**
                                                  ...
                                                  unscaledHeight:Number):void
    {
        ...
        if (border)
        {
            ...
            bm = border is RectangularBorder ?
        ...
        textField.width = Math.max(0, unscaledWidth - (bm.left + bm.right));
                                      ...
                                      dispatchValueCommitEvent:Boolean):void
    {
        ...
        changed = _htmlText != textField.htmlText;
