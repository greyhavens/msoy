 ...
 *  whether the column is editable, sortable, or resizeable;
...
public class DataGridColumn extends CSSStyleDeclaration implements IIMESupport
{
     ...
     */
    mx_internal var owner:DataGrid;
    ...
    override mx_internal function addStyleToProtoChain(
                                chain:Object, target:DisplayObject):Object
    {
        var parentGrid:DataGrid = owner;
        ...
        return super.addStyleToProtoChain(chain, target);
    }
