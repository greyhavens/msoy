   ...
   /**
    ...
    override protected function configureScrollBars():void
    {
        ...
        if (colCount > 1 && visibleColumns[colCount - 1] == displayableColumns[displayableColumns.length - 1]
            && listItems[0][colCount - 1].x + visibleColumns[colCount - 1].width > displayWidth)
            colCount--;
		...
		if (!verticalScrollBar && collection &&
			collection.length - lockedRowCount + headerShift > rowCount - lockedRowCount)
			maxVerticalScrollPosition = collection.length - lockedRowCount + headerShift - (rowCount - lockedRowCount);
