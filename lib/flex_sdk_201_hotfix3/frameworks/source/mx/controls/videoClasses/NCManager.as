...
public class NCManager implements INCManager
{
	 ...
	 *  @private
     */	
	private static var resourceInvalidCall:String;

    /**
	 *  @private
     */	
	private static var resourceNameNotFound:String;

    /**
	 *  @private
     */	
	private static var resourceCannotSwitchRTMP:String;

    /**
	 *  @private
     */	
	private static var resourceIllegalAttributes:String;

    /**
	 *  @private
     */	
	private static var resourceWrongURL:String;

    /**
	 *  @private
     */	
	private static var resourceMissingParameter:String;

    /**
	 *  @private
     */	
	private static var resourceWrongParameter:String;

    /**
	 *  @private
     */	
	private static var resourceCannotSwitchFPAD:String;	
	...
	{
		resourceInvalidCall = packageResources.getString("invalidCall");
		resourceNameNotFound = packageResources.getString("nameNotFound");
		resourceCannotSwitchRTMP = packageResources.getString("cannotSwitchRTMP");
		resourceIllegalAttributes = packageResources.getString("illegalAttributes");
		resourceWrongURL = packageResources.getString("wrongURL");		
		resourceMissingParameter = packageResources.getString("missingParameter");
		resourceWrongParameter = packageResources.getString("wrongParameter");
		resourceCannotSwitchFPAD = packageResources.getString("cannotSwitchFPAD");			
	}
    ...
    {
        if (!_isRTMP)
            throw new Error(resourceInvalidCall);
