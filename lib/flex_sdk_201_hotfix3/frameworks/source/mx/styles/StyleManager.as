...
public class StyleManager
{
	 ...
	 *  @private
	 */
    private static var impl:IStyleManager = Singleton
     ...
     *  @param update Set to <code>true</code> to force an immediate update of the styles; internally, Flash Player
     ...
     *  so that Flash Player does not call the <code>styleChanged()</code> method multiple times.</p>
     * 
     *  <p>If you call the <code>getStyle()</code> method, Flash Player returns the style value 
    ...
    {
        return impl.loadStyleDeclarations(url, update, trustContent);
    }
