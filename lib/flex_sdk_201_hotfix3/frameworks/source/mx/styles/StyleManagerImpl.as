...
public class StyleManagerImpl implements IStyleManager
{
     ...
     *  @private
     */ 
    private var resourceUnableToLoad:String = null;
     ...
     *  @private
     */
    private static var instance:IStyleManager;
    ...
    {
        resourceUnableToLoad = packageResources.getString("unableToLoad");
    }
     ...
     *         The default is true.
     *  @param trustContent If <code>true</code>, the content is loaded
     *         into your security domain.  The default is false.
     *
                                ...
                                trustContent:Boolean = false):IEventDispatcher
    {
        ...
        {
            if (resourceUnableToLoad == null)
            {
                loadResources();
            }

            var errorText:String = StringUtil.substitute(resourceUnableToLoad,
                                                         moduleEvent.errorText,
                                                         url);
