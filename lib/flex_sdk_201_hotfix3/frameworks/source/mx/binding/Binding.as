...
public class Binding
{
	...
	/**
 	 *  @private
     *  If there is a sole UIComponent that is part of this binding expression,
	 *  store the id of the Watcher to it.
     *  This way Validators can determine a default listener
     */
