...
public class PropertyWatcher extends Watcher
{
     ...
     */
    private var _propertyGetter:Function;

    /**
     *  The function for accessing the parent's property.
     */
    public function set propertyGetter(value:Function):void
    {
    ...
    {
        var clone:PropertyWatcher = new PropertyWatcher(_propertyName, events);

        if (_propertyGetter != null)
        {
            clone.propertyGetter = _propertyGetter;
        }
    ...
    private function updateProperty():void
    {
        if (parentObj)
        {
            ...
            else
            {
                if (_propertyGetter != null)
                {
                    value = _propertyGetter.apply(parentObj,
												  [ _propertyName ]);
                }
                else
                {
