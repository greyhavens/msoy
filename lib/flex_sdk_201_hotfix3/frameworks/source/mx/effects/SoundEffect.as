...
public class SoundEffect extends Effect
{
     ...
     *  @private
     */ 
    private static var resourceIncorrectSource:String;
    ...
    {
        resourceIncorrectSource = packageResources.getString("incorrectSource");
    }
    ...
    {   
        ...
        {
            throw new Error(resourceIncorrectSource);
        }
