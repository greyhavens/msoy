...
public class EffectManager extends EventDispatcher
{
	 ...
	 *  @private
     */	
	private static var resourceIncorrectTrigger:String;
	...
	{
		resourceIncorrectTrigger = packageResources.getString("incorrectTrigger");
	}
	...
	private static function createAndPlayEffect(eventObj:Event, target:Object):void
	{
		...
		if (effectInst is Zoom && eventObj.type == MoveEvent.MOVE)
			throw new Error(resourceIncorrectTrigger);
		...
		effectInst.mx_internal::initEvent = eventObj;
