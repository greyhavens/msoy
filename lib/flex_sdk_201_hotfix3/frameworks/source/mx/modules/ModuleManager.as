...
class ModuleInfoProxy extends EventDispatcher implements IModuleInfo
{
    ...
    public function ModuleInfoProxy(info:ModuleInfo)
    {
        ...
        info.addEventListener(ModuleEvent.SETUP, moduleEventHandler);
        info.addEventListener(ModuleEvent.PROGRESS, moduleEventHandler);
        info.addEventListener(ModuleEvent.READY, moduleEventHandler);
        info.addEventListener(ModuleEvent.ERROR, moduleEventHandler);
        info.addEventListener(ModuleEvent.UNLOAD, moduleEventHandler);
    }
