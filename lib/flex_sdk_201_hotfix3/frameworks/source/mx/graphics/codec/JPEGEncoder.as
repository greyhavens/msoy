...
/**
 * An implementation of IImageEncoder that converts raw bitmaps into encoded
...
public class JPEGEncoder implements IImageEncoder
{
    ...
    /**
     * Constructor.
     * @param quality A value between 1 and 100. The default is 50.
     */
     ...
     * ByteArray. Transparency is not supported however 4 bytes must still be
     * sent per pixel in ARGB format.
     */
