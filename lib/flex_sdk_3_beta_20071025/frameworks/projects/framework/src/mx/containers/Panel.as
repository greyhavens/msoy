	...
	implements IConstraintLayout, IFontContextComponent
{
     ...
     *  @see #titleBar
     */
    protected var statusTextField:UITextField;
    ...
    override protected function commitProperties():void
    {
        ...
        if (hasFontContextChanged())
        {
            ...
            if (titleTextField)
            {
                childIndex = titleBar.getChildIndex(titleTextField);
            ...
            if (statusTextField)
            {
                childIndex = titleBar.getChildIndex(statusTextField);
    ...
    mx_internal function createTitleTextField(childIndex:int):void
    {
        ...
        if (!titleTextField)
        {
            ...
            if (childIndex == -1)
				...
				titleBar.addChildAt(titleTextField, childIndex);
    ...
    mx_internal function createStatusTextField(childIndex:int):void
    {
        ...
        if (titleBar && !statusTextField)
        {
            ...
            if (childIndex == -1)
                titleBar.addChild(statusTextField);                
            else 
                titleBar.addChildAt(statusTextField, childIndex);
     ...
     *  and therefore available only to subclasses.
     */
    mx_internal function getTitleTextField():UITextField
    {
     ...
     *  and therefore available only to subclasses.
     */
    mx_internal function getStatusTextField():UITextField
    {
