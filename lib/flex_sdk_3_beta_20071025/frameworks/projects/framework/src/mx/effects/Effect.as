...
public class Effect extends EventDispatcher implements IEffect
{
	...
	/**
	 *  @private
	 *  Storage for the instanceClass property.
	 */
	private var _instanceClass:Class = IEffectInstance;

    /**
     *  @copy mx.effects.IEffect#instanceClass
     */
    ...
    /**
     *  @copy mx.effects.IEffect#repeatCount
     */
    ...
    /**
     *  @copy mx.effects.IEffect#repeatDelay
     */
    ...
    /**
     *  @copy mx.effects.IEffect#startDelay
     */
    ...
    /**
     *  @copy mx.effects.IEffect#suspendBackgroundProcessing
     */
