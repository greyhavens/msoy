...
{ 
    ...
    {   
        ...
        var hasPanelParent:Boolean = parent as Panel;
        var controlBar:IUIComponent = hasPanelParent ? Panel(parent).mx_internal::_controlBar : null;        
        var hHeight:Number = hasPanelParent ? Panel(parent).mx_internal::getHeaderHeightProxy() : NaN;
