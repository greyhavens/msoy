...
public class CursorManagerImpl implements ICursorManager
{
                                     ...
                                     yOffset:Number = 0, setter:IUIComponent = null):int 
    {
        ...
        */
        ...
        item.x = xOffset;
        item.y = yOffset;
        if (setter && setter.systemManager && setter.systemManager.topLevelSystemManager)
        	item.systemManager = setter.systemManager.topLevelSystemManager;
        else
        	item.systemManager = Application.application.systemManager;
