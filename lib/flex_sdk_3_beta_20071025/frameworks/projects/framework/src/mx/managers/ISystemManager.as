...
public interface ISystemManager extends IEventDispatcher, IChildList, IFlexModuleFactory
{
	...
	function get cursorChildren():IChildList;
        ...
        /**
         * We use this, instead of explicit references to 'stage', so that we can prevent
         * security errors when we're running inside a security boundary.
         */
        function get displayListHandle () :DisplayObject;
