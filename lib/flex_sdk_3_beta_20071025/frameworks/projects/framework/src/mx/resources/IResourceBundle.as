 ...
 *  will produce a resource bundle with <code>"MyResources"</code>
 *  for its <code>bundleName</code>.
 *  You generally produce multiple version of each .properties file,
 *  one for each locale that your application supports.</p>
 *
 *  <p>Flex .properties files are similar to Java's,
...
public interface IResourceBundle
{
	 ...
	 *
	 *  <p>In general, you should access resources using IResourceManager
	 ...
	 *  <code>-compiler.locale</code> option of mxmlc or compc.
