...
public class ResourceManager extends EventDispatcher implements IResourceManager
{
    ...
    public static function getInstance():IResourceManager
    {
        if (!instance)
        {
            var c:Class = Singleton.getClass("mx.resources::IResourceManager");
			if (!c)
				c = ResourceManager;
            instance = new c();
        }
     ...
     */
    mx_internal function installCompiledResourceBundles(
	...
	private function supportNonFrameworkApps():void
	{
		...
		mx_internal::installCompiledResourceBundles(
