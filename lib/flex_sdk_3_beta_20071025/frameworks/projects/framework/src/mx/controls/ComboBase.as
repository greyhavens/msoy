...
public class ComboBase extends UIComponent implements IIMESupport, IFocusManagerComponent
{
	...
	/**
	 *  Set of styles to pass from the ComboBase to the downArrow button
    ...
    /**
     *  The set of styles to pass from the ComboBase to the textInput. 
     *  These are ignored if a textInputStyleName is specified.
     *  @see mx.styles.StyleProxy
     *  @review
     */
