...
public class DataGrid extends DataGridBase implements IIMESupport
{
                                                  ...
                                                  unscaledHeight:Number):void
    {
           ...
           headerVisible)
        {
                        ...
                        unscaledHeight-hh-bm.top-bm.bottom))
            {
                ...
                maskShape.width = unscaledWidth - bm.left - bm.right;
   ...
   /**
    ...
    override protected function configureScrollBars():void
    {
        ...
        if (collectionHasRows && rowCount > 1 && colCount > 1 && 
                                            ...
                                            color:uint, column:DataGridColumn):void
    {
        ...
        var xx:Number = DataGridHeader(header).rendererArray[columnIndex].x
        ...
        g.drawRect(xx, yy, DataGridHeader(header).rendererArray[columnIndex].width,
                   listContent.height - yy);
        g.endFill();
    }
    ...
    protected function drawLinesAndColumnGraphics(contentHolder:ListBaseContentHolder, visibleColumns:Array, separators:Object):void
    {
		...
		{
			if (contentHolder.listItems[0].length)
...
//          invInitHeaders = true;
    ...
    override protected function focusInHandler(event:FocusEvent):void
    {
        ...
        if (editable && !isPressed) // don't do this if we're mouse focused
        {
            ...
            if (foundOne)
            {
                ...
                dataGridEvent.dataField = displayableColumns[_editedItemPosition.columnIndex].dataField;
    ...
    override public function hideDropFeedback(event:DragEvent):void
    {
        ...
        if (lockedColumnDropIndicator)
        {
            lockedColumnContent.removeChild(DisplayObject(lockedColumnDropIndicator));
