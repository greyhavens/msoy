 ...
 *  This property is supported by the List and TileList controls.
 *
                      ...
                      IEffectTargetHost
{
   ...
   /**
    ...
    /**
     *  Get the appropriate factory, using the default factory if none specified
     */
        ...
        switch (code)
        {
            ...
            case Keyboard.PAGE_UP:
            {
                ...
                else
                {
                    ...
                    caretIndex = Math.max(caretIndex - onscreenRowCount, 0);
    ...
    mx_internal function commitSelectedIndex(value:int):void
    {
        if (value != -1)
        {
            ...
            if (!selectedData[uid])
            {
                if (listContent && visibleData && visibleData[uid])
    ...
    protected function mouseDownHandler(event:MouseEvent):void
    {
        ...
        systemManager.displayListHandle.addEventListener(Event.MOUSE_LEAVE, mouseLeaveHandler, false, 0, true);
    ...
    private function mouseIsUp():void
    {
        ...
        systemManager.displayListHandle.removeEventListener(Event.MOUSE_LEAVE, mouseLeaveHandler);
