...
public class ProgressBar extends UIComponent implements IFontContextComponent
{
     ...
     *  @private
     */
    mx_internal var _labelField:UITextField;
    ...
    override protected function createChildren():void
    {
        ...
        if (!_labelField)
        {
            _labelField = UITextField(createInFontContext(UITextField));
    ...
    override protected function commitProperties():void
    {
        ...
        {
        	var index:int = getChildIndex(_labelField);
            removeChild(_labelField);
            _labelField = UITextField(createInFontContext(UITextField));
            _labelField.styleName = this;
            addChildAt(_labelField, index);
        }
