       ...
       IFontContextComponent
{
    ...
    override protected function createChildren():void
    {
        ...
        if (!textField)
        {
            textField = UITextField(createInFontContext(UITextField));
    ...
    override protected function measure():void
    {
        ...
        var bm:EdgeMetrics = currentSkin &&
                             currentSkin is Border ?
                             Border(currentSkin).borderMetrics :
                             null;
    ...
    mx_internal function viewIconForPhase(tempIconName:String):IFlexDisplayObject
    {
        ...
        if (!newIconClass)
        {
            ...
            if (!checkedDefaultIcon && newIconClass)
            {
                ...
                if (!(newIcon is ProgrammaticSkin) && newIcon is IStateClient)
                {
        ...
        if (newIcon == null)
        {
            if (newIconClass != null)
            {
                ...
                else if (newIcon is ProgrammaticSkin)
                {
                    ProgrammaticSkin(newIcon).validateDisplayList();
                    sizeIcon = true;
                }
