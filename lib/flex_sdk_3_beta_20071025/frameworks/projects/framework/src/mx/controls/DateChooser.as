...
/**
 *  @review NEEDS REVIEW
 *  Default skin for the next Month arrow.
 */
...
/**
 *  @review NEEDS REVIEW
 *  Default skin for the next Year arrow.
 */
...
/**
 *  @review NEEDS REVIEW
 *  Default skin for the previous Month arrow
 */
...
/**
 *  @review NEEDS REVIEW
 *  Default skin for previous Year arrow 
 */
...
public class DateChooser extends UIComponent implements IFocusManagerComponent, IFontContextComponent
{
    ...
    /**
     *  The set of styles to pass from the DateChooser to the nextMonth button.
     *  @see mx.styles.StyleProxy
     *  @review
     */
    ...
    /**
     *  The set of styles to pass from the DateChooser to the nextYear button.
     *  @see mx.styles.StyleProxy
     *  @review
     */
    ...
    /**
     *  The set of styles to pass from the DateChooser to the prevMonth button.
     *  @see mx.styles.StyleProxy
     *  @review
     */    
    ...
    /**
     *  The set of styles to pass from the DateChooser to the prevYear button.
     *  @see mx.styles.StyleProxy
     *  @review
     */    
    ...
    override protected function commitProperties():void
    {
        ...
        if (hasFontContextChanged() && yearDisplay != null)
        {
            ...
            var childIndex:int = getChildIndex(yearDisplay);
            removeYearDisplay();
            createYearDisplay(childIndex);

            childIndex= getChildIndex(monthDisplay);
            removeMonthDisplay();
    ...
    mx_internal function createMonthDisplay(childIndex:int):void
    {
        if (!monthDisplay)
        {
            monthDisplay = UITextField(createInFontContext(UITextField));
            ...
            if (childIndex == -1)
                ...
                addChildAt(monthDisplay, childIndex);
    ...
    mx_internal function createYearDisplay(childIndex:int):void
    {
        if (!yearDisplay)
        {
            yearDisplay = UITextField(createInFontContext(UITextField));
            ...
            if (childIndex == -1)
                ...
                addChildAt(yearDisplay, childIndex);
