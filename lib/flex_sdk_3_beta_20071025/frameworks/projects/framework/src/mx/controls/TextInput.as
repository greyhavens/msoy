 ...
 *  is <code>true</code>, this control calls the <code>stopImmediatePropagation()</code> method 
 *  to prevent event bubbling.</p>
 *
...

{
   ...
   /**
    ...
    override protected function commitProperties():void
    {
        ...
        {
            var childIndex:int = getChildIndex(textField);
            removeTextField();
