...
/**
 * Hackery to pass POST requests through the GWT shell and on to the actual MSOY server which is
 * running separately. This is only used during development, in deployment the AJAX code just talks
 * directly to the MSOY server.
 */
public class RedirectServlet extends HttpServlet
{
        ...
        throws ServletException, IOException
    {
        ...
        try {
            ...
            URL url = new URL("http", "localhost", ServerConfig.getHttpPort(), requrl.getPath());
