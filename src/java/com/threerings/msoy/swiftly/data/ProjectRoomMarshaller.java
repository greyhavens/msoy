...
{
    /** The method id used to dispatch {@link #abortFileUpload} requests. */
    public static final int ABORT_FILE_UPLOAD = 1;

    // from interface ProjectRoomService
    public void abortFileUpload (Client arg1, InvocationService.ConfirmListener arg2)
    {
        InvocationMarshaller.ConfirmMarshaller listener2 = new InvocationMarshaller.ConfirmMarshaller();
        listener2.listener = arg2;
        sendRequest(arg1, ABORT_FILE_UPLOAD, new Object[] {
            listener2
        });
    }
    ...
    public static final int COMMIT_PROJECT = 5;
    ...
    public static final int DELETE_PATH_ELEMENT = 7;
    ...
    public static final int FINISH_FILE_UPLOAD = 8;
    ...
    public static final int LOAD_DOCUMENT = 9;
    ...
    public static final int RENAME_PATH_ELEMENT = 10;
    ...
    public static final int START_FILE_UPLOAD = 11;
