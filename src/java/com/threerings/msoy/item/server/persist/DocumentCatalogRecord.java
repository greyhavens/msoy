...
public class DocumentCatalogRecord extends CatalogRecord
{
    ...
    public static final ColumnExp CURRENCY_C =
        new ColumnExp(DocumentCatalogRecord.class, CURRENCY);

    /** The qualified column identifier for the {@link #cost} field. */
    public static final ColumnExp COST_C =
        new ColumnExp(DocumentCatalogRecord.class, COST);
    ...
    public static final ColumnExp FAVORITE_COUNT_C =
        new ColumnExp(DocumentCatalogRecord.class, FAVORITE_COUNT);
