...
public class AudioCatalogRecord extends CatalogRecord
{
    ...
    public static final ColumnExp ORIGINAL_ITEM_ID_C =
        new ColumnExp(AudioCatalogRecord.class, ORIGINAL_ITEM_ID);
    ...
    public static final ColumnExp FAVORITE_COUNT_C =
        new ColumnExp(AudioCatalogRecord.class, FAVORITE_COUNT);
