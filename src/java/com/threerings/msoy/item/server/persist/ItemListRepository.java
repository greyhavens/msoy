...
public class ItemListRepository extends DepotRepository
{
    @Computed
    @Entity
    public static class ListSizeRecord extends PersistentRecord {
     ...
     */
    public void createList (ItemListInfoRecord record) throws PersistenceException
    {
        if (record.listId != 0) {
     ...
     */
    public void deleteList (int listId) throws PersistenceException
    {
     ...
     * @throws PersistenceException
     */
    public int getSize (int listId) throws PersistenceException
    {
        ListSizeRecord count = load(ListSizeRecord.class, 
     ...
     */
    public ItemListInfoRecord loadInfo (int listId) throws PersistenceException
    {
     ...
     */
    public List<ItemListInfoRecord> loadInfos (int memberId) throws PersistenceException
    {
     ...
     */
    public List<ItemListInfoRecord> loadInfos (int memberId, byte type) throws PersistenceException
    {
        // query by type 
     ...
     */
    public ItemIdent[] loadList (int listId) throws PersistenceException
    {
     ...
     */
    public ItemIdent[] loadList (int listId, int offset, int count) throws PersistenceException
    {
        List<ItemListElementRecord> list = findAll(ItemListElementRecord.class, 
            new Where(ItemListElementRecord.LIST_ID_C, listId), 
            OrderBy.ascending(ItemListElementRecord.SEQUENCE_C), 
     ...
     */
    public boolean removeItem (int listId, ItemIdent item) throws PersistenceException
    {
     ...
     * @throws PersistenceException
     */
    public void insertItemAt (int listId, ItemIdent item, short index) throws PersistenceException
    {
     ...
     */
    public void moveItem (int listId, ItemIdent item, short toIndex) throws PersistenceException
    {
        // get the item's current location in the list
     ...
     */
    protected void shiftItemsRight(int listId, final short fromIndex) throws PersistenceException 
    {
     ...
     */
    protected void shiftItemsLeft(int listId, final short fromIndex) throws PersistenceException 
    {
     ...
     */
    protected void shiftItems(int listId, final short fromIndex, final short toIndex) throws PersistenceException 
    {
