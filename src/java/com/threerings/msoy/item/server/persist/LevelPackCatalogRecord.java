...
public class LevelPackCatalogRecord extends CatalogRecord
{
    ...
    public static final ColumnExp FAVORITE_COUNT_C =
        new ColumnExp(LevelPackCatalogRecord.class, FAVORITE_COUNT);
