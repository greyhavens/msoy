...
/** Catalog Records for Mobs. */
@TableGenerator(name="catalogId", pkColumnValue="MOB_CATALOG")
public class MobCatalogRecord extends CatalogRecord<MobRecord>
{
    ...
    public static final ColumnExp PURCHASES_C =
        new ColumnExp(MobCatalogRecord.class, PURCHASES);

    /** The qualified column identifier for the {@link #returns} field. */
    public static final ColumnExp RETURNS_C =
        new ColumnExp(MobCatalogRecord.class, RETURNS);
    // AUTO-GENERATED: FIELDS END

    // AUTO-GENERATED: METHODS START
    /**
     * Create and return a primary {@link Key} to identify a {@link #MobCatalogRecord}
     * with the supplied key values.
     */
    public static Key<MobCatalogRecord> getKey (int catalogId)
    {
        return new Key<MobCatalogRecord>(
                MobCatalogRecord.class,
