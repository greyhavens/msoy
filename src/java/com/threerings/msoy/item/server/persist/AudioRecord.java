...
public class AudioRecord extends ItemRecord
{
    ...
    public static final ColumnExp<byte[]> AUDIO_MEDIA_HASH = colexp(_R, "audioMediaHash");
    public static final ColumnExp<Byte> AUDIO_MIME_TYPE = colexp(_R, "audioMimeType");
