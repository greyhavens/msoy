...
/**
 * Domain object representing an entry in a member's account history.  The account history
 * keeps track of all changes to money in a member's account over time.
 * 
...
public class MemberAccountHistoryRecord extends PersistentRecord
{
     ...
     */
    public MemberAccountHistoryRecord (final int memberId, final Date timestamp, final MoneyType type, final double amount,
        final boolean spent, final String description)
    {
        this.memberId = memberId;
        this.timestamp = new Timestamp(timestamp.getTime());
        this.type = type;
    ...
    /** True if the amount was debited, otherwise it was credited.  Note: this is not part of the API, do not use it. */
    public boolean spent;
    
    /** Description of the transaction.  Note: this is not part of the API, do not use it. */
    public String description;
    
    /** ID of the item involved in this transaction, or 0 otherwise.  Note: this is not part of the API, do not use it. */
    public int itemId;
    
    /** Type of the item involved in this transaction, if provided.  Note: this is not part of the API, do not use it. */
    public int itemType;
}
