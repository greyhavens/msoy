...
/**
 * Provides peer-aware cron services for Whirled. Jobs are scheduled at fixed wall times and the
 * peers coordinate to ensure that only one peer runs a job at its scheduled wall time.
 *
