...
public interface ChatChannelProvider extends InvocationProvider
{
     ...
     */
    void createChannel (ClientObject caller, String arg1, InvocationService.ResultListener arg2)
        throws InvocationException;

    /**
     * Handles a {@link ChatChannelService#inviteToChannel} request.
     */
    void inviteToChannel (ClientObject caller, MemberName arg1, ChatChannel arg2, InvocationService.ConfirmListener arg3)
        throws InvocationException;

    /**
     * Handles a {@link ChatChannelService#joinChannel} request.
     */
    void joinChannel (ClientObject caller, ChatChannel arg1, InvocationService.ResultListener arg2)
        throws InvocationException;

    /**
     * Handles a {@link ChatChannelService#leaveChannel} request.
     */
    void leaveChannel (ClientObject caller, ChatChannel arg1);
}
