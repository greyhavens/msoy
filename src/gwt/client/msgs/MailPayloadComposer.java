 ...
 * #widgetForComposition(MsgsContext)} to hand out a Widget with the appropriate configuration
 * elements.
 * 
...
public interface MailPayloadComposer
{
     ...
     * {@link #widgetForComposition(MsgsContext)}. This method may return null, in which case no
     * {@link MailPayload} is sent.
     */
