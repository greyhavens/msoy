 ...
 * 	/export/msoy/src/gwt/client/group/GroupMessages.properties'.
 */
public interface GroupMessages extends com.google.gwt.i18n.client.Messages {
   ...
   * Translated "Set {0}".
   * 
   * @return translated "Set {0}"
   * @gwt.key editSetBG
   */
  String editSetBG(String arg0);
   ...
   * 
   * @return translated "Invitation Only"
   * @gwt.key policyInvite
   */
  String policyInvite();
   ...
   * 
   * @return translated "Popular Tags:"
  ...
  /**
   * Translated "Failed to load photo inventory for logo selection: {0}".
   * 
   * @return translated "Failed to load photo inventory for logo selection: {0}"
   * @gwt.key errPhotoLoadFailed
   */
   ...
   * @gwt.key errUnknownPolicy
   */
  String errUnknownPolicy(String arg0);
  ...
  /**
   * Translated "{0} members".
   * 
   * @return translated "{0} members"
