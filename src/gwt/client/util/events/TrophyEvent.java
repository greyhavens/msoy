...
public class TrophyEvent extends FlashEvent
{
    ...
    /**
     * Checks if this event was generated by an explicit request to publish an old trophy or if
     * it was sent at the time of earning.
     */
    public boolean isManualPublish ()
    {
        return _manualPublish;
    }
    ...
    public void fromJSObject (JavaScriptObject args)
    {
        ...
        _manualPublish = JavaScriptUtil.getBooleanElement(args, 8);
    }
    ...
    public void toJSObject (JavaScriptObject args)
    {
        ...
        JavaScriptUtil.setBooleanElement(args, 8, _manualPublish);
    }
    ...
    protected boolean _manualPublish;
}
