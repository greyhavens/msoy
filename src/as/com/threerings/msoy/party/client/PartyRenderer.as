//
// $Id: FriendRenderer.as 9991 2008-07-23 22:58:17Z bruno $
...
public class PartyRenderer extends HBox 
{
    ...
    protected function configureUI () :void
    {
        ...
        labelBox.width = 
            PartyPopup.POPUP_WIDTH - MediaDesc.THUMBNAIL_WIDTH / 2 - ScrollBar.THICKNESS -
            4 /* list border * 2 */ - 6 /* padding */;
        addChild(labelBox);

        var friendLabel :Label = new Label();
        friendLabel.styleName = "friendLabel";
        friendLabel.text = _mate.getName().toString();
